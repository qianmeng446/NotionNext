...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://qianmeng.pp.ua', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '千梦,空间,千梦空间站,币安,币安下载,币安注册,币安官网,币安官方注册,qianmeng,玩机教程,安卓逆向,电脑软件,科技教程,火币,免费vpn,机场破解软件,gate,Gate,bitget,deep,deepcoin,火币,手续费返佣,返佣,手续费最高返佣,加密货币,bic,比特币,节点,xt,XT,博客,开发', // 网站关键词 英文逗号隔开
