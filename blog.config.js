...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '千梦微信；dlsx41258,有任何问题可以加v联系，欢迎大家骚扰！', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://qianmeng666.us.kg', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '千梦,空间站,节点,qianmeng', // 网站关键词 英文逗号隔开
  ...
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '@dlsx666', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/qianmeng666', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || '', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://www.youtube.com/@%E5%8D%83%E6%A2%A6666', // Youtube主页
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '1252607714', // 对应歌单的 id
