...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '千梦,空间,qianmeng,玩机教程,安卓逆向,电脑软件,科技教程,免费vpn,机场破解软件,gate,Gate,bitget,deep,deepcoin,火币,手续费返佣,返佣,手续费最高返佣,加密货币,bic,比特币,节点', // 网站关键词 英文逗号隔开
