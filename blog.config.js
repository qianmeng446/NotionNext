...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'qianmeng666.us.kg', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'qianmeng,千梦,千梦社区,千梦空间', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'qianmengCommunity@hotmail', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 't.me/qianmeng888', // 你的telegram 地址 例如 https://t.me/tangly_1024
