...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '141d86507b5480409b68da097f0ce632',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '千梦, 空间,qianmeng', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'qianmengCommunity@hotmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://weibo.com/u/7284521123', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/qianmeng888', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || '', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://www.youtube.com/@千梦666', // Youtube主页
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    ...
    },
    {
      name: 'normal no more',
      artist: '高音质',
      url: 'https://ws.stream.qqmusic.qq.com/M500001Y1Dev07pcso.mp3?guid=613501078&vkey=F03B496B54CCC07D2838D6931EB377940E5195CE5440A88F30DCCEACCCAC7EA4167C6EA29D3E7CB981503F72183B114048BCD18B95F0D33B__v215192f04&uin=&fromtag=120042',
      cover:
        'https://ibb.co/x39SzFZ'
    }
  ],
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-3387106088342814', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  IMG_LAZY_LOAD_PLACEHOLDER:
    ...
    'https://ibb.co/PQg5PZ1', // 懒加载占位图片地址，支持base64或url
